...
- **WhatsApp (canal inativo 10–11/Ago, Baileys)**: 228 falhas `Connection Closed` vs 13 enviados (~5% success). Novo Cloud API deployado mas sem log (schema antigo) — **desbloqueado a 13/Ago** com a migration; falta configurar env vars no Render + templates Meta aprovados + webhook.
